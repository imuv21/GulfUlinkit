...
const AboutUs = () => {
  ...
  const teamTalent = [
    ...
    { id: 3, name: 'Cutting-Edge Technology', info: 'At Alayra Tech, we leverage the latest tools and technologies to provide our clients with services that are not just current but also future-proof. Whether it’s web development, digital marketing, or design, we utilize state-of-the-art technology to deliver superior results.' },
